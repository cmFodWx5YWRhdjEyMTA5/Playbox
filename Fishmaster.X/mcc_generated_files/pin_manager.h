...
#define IO_TM1_TRIS               TRISAbits.TRISA4
#define IO_TM1_LAT                LATAbits.LATA4
#define IO_TM1_PORT               PORTAbits.RA4
#define IO_TM1_WPU                WPUAbits.WPUA4
#define IO_TM1_ANS                ANSELAbits.ANSA4
#define IO_TM1_SetHigh()            do { LATAbits.LATA4 = 1; } while(0)
#define IO_TM1_SetLow()             do { LATAbits.LATA4 = 0; } while(0)
#define IO_TM1_Toggle()             do { LATAbits.LATA4 = ~LATAbits.LATA4; } while(0)
#define IO_TM1_GetValue()           PORTAbits.RA4
#define IO_TM1_SetDigitalInput()    do { TRISAbits.TRISA4 = 1; } while(0)
#define IO_TM1_SetDigitalOutput()   do { TRISAbits.TRISA4 = 0; } while(0)
#define IO_TM1_SetPullup()      do { WPUAbits.WPUA4 = 1; } while(0)
#define IO_TM1_ResetPullup()    do { WPUAbits.WPUA4 = 0; } while(0)
#define IO_TM1_SetAnalogMode()  do { ANSELAbits.ANSA4 = 1; } while(0)
#define IO_TM1_SetDigitalMode() do { ANSELAbits.ANSA4 = 0; } while(0)
...
#define IO_TM2_TRIS               TRISAbits.TRISA6
#define IO_TM2_LAT                LATAbits.LATA6
#define IO_TM2_PORT               PORTAbits.RA6
#define IO_TM2_WPU                WPUAbits.WPUA6
#define IO_TM2_SetHigh()            do { LATAbits.LATA6 = 1; } while(0)
#define IO_TM2_SetLow()             do { LATAbits.LATA6 = 0; } while(0)
#define IO_TM2_Toggle()             do { LATAbits.LATA6 = ~LATAbits.LATA6; } while(0)
#define IO_TM2_GetValue()           PORTAbits.RA6
#define IO_TM2_SetDigitalInput()    do { TRISAbits.TRISA6 = 1; } while(0)
#define IO_TM2_SetDigitalOutput()   do { TRISAbits.TRISA6 = 0; } while(0)
...
#define IO_TM3_TRIS               TRISCbits.TRISC0
#define IO_TM3_LAT                LATCbits.LATC0
#define IO_TM3_PORT               PORTCbits.RC0
#define IO_TM3_WPU                WPUCbits.WPUC0
#define IO_TM3_SetHigh()            do { LATCbits.LATC0 = 1; } while(0)
#define IO_TM3_SetLow()             do { LATCbits.LATC0 = 0; } while(0)
#define IO_TM3_Toggle()             do { LATCbits.LATC0 = ~LATCbits.LATC0; } while(0)
#define IO_TM3_GetValue()           PORTCbits.RC0
#define IO_TM3_SetDigitalInput()    do { TRISCbits.TRISC0 = 1; } while(0)
#define IO_TM3_SetDigitalOutput()   do { TRISCbits.TRISC0 = 0; } while(0)
#define IO_TM3_SetPullup()      do { WPUCbits.WPUC0 = 1; } while(0)
#define IO_TM3_ResetPullup()    do { WPUCbits.WPUC0 = 0; } while(0)
...
#define IO_TM4_TRIS               TRISCbits.TRISC3
#define IO_TM4_LAT                LATCbits.LATC3
#define IO_TM4_PORT               PORTCbits.RC3
#define IO_TM4_WPU                WPUCbits.WPUC3
#define IO_TM4_SetHigh()            do { LATCbits.LATC3 = 1; } while(0)
#define IO_TM4_SetLow()             do { LATCbits.LATC3 = 0; } while(0)
#define IO_TM4_Toggle()             do { LATCbits.LATC3 = ~LATCbits.LATC3; } while(0)
#define IO_TM4_GetValue()           PORTCbits.RC3
#define IO_TM4_SetDigitalInput()    do { TRISCbits.TRISC3 = 1; } while(0)
#define IO_TM4_SetDigitalOutput()   do { TRISCbits.TRISC3 = 0; } while(0)
#define IO_TM4_SetPullup()      do { WPUCbits.WPUC3 = 1; } while(0)
#define IO_TM4_ResetPullup()    do { WPUCbits.WPUC3 = 0; } while(0)

// get/set IO_TM5 aliases
#define IO_TM5_TRIS               TRISCbits.TRISC4
#define IO_TM5_LAT                LATCbits.LATC4
#define IO_TM5_PORT               PORTCbits.RC4
#define IO_TM5_WPU                WPUCbits.WPUC4
#define IO_TM5_SetHigh()            do { LATCbits.LATC4 = 1; } while(0)
#define IO_TM5_SetLow()             do { LATCbits.LATC4 = 0; } while(0)
#define IO_TM5_Toggle()             do { LATCbits.LATC4 = ~LATCbits.LATC4; } while(0)
#define IO_TM5_GetValue()           PORTCbits.RC4
#define IO_TM5_SetDigitalInput()    do { TRISCbits.TRISC4 = 1; } while(0)
#define IO_TM5_SetDigitalOutput()   do { TRISCbits.TRISC4 = 0; } while(0)
#define IO_TM5_SetPullup()      do { WPUCbits.WPUC4 = 1; } while(0)
#define IO_TM5_ResetPullup()    do { WPUCbits.WPUC4 = 0; } while(0)
