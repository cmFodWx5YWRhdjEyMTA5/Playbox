...
import uk.co.darkerwaters.scorepal.activities.handlers.GameParentRecyclerAdapter;
...
public class MainActivity extends AppCompatActivity {
        ...
        protected void onResume() {
            ...
            recyclerView.setAdapter(new GameParentRecyclerAdapter(application, new Object[10]));
        }
