...
public class DecidingPointTextAnimation extends TextViewAnimation {
    ...
    public DecidingPointTextAnimation(Activity context, TextView view) {
        super(context, view, K_REPETITIONS);
        // set the text content on the view
        setAnimatedText(context.getString(R.string.deciding_point));
