...
public class DriveServiceHelper {
    ...
    public Task<GoogleDriveFileHolder> createTextFile(final String fileName, final String content, final String folderId) {
    ...
    public Task<List<GoogleDriveFileHolder>> listApplicationFiles() {
        return Tasks.call(mExecutor, new Callable<List<GoogleDriveFileHolder>>() {
            ...
            public List<GoogleDriveFileHolder> call() throws Exception {
                FileList files = mDriveService.files().list()
                        ...
                        .setPageSize(10)
                        .execute();
                ArrayList<GoogleDriveFileHolder> fileList = new ArrayList<GoogleDriveFileHolder>(files.size());
