 ...
 * @see SystemUiHider
 */
public class CopyOfScoreboardActivity extends Activity implements OnClickListener, OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wordList.setOnItemClickListener(new OnItemClickListener() {
		    ...
		    public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
		    {
		        ...
		        Toast.makeText(CopyOfScoreboardActivity.this, "You said: "+wordChosen, Toast.LENGTH_SHORT).show();//**alter for your Activity name***
